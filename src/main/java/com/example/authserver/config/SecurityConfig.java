...
public class SecurityConfig {
	...
	public UserDetailsService userDetailsService() {
		UserDetails userDetails = User.withDefaultPasswordEncoder().username("jefferson").password("teste123")
				.roles("TESTE").build();
					 
		UserDetails userDetails2 = User.withDefaultPasswordEncoder().username("ricardo").password("teste123")
				.roles("TESTE").build();

		UserDetails userDetails3 = User.withDefaultPasswordEncoder().username("douglas").password("teste123")
				.roles("TESTE").build();
